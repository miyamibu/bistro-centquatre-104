...
20. `CONTACT_PHONE_E164`
Purpose: server-side canonical phone number.
Source: current `.env.local`.

21. `CONTACT_PHONE_DISPLAY`
...
31. `LINE_MONTHLY_REMINDER_LIMIT` (optional, default 200)
Purpose: Monthly LINE push notification hard limit.

32. `LINE_MONTHLY_REMINDER_WARN_THRESHOLD` (optional, default 180)
