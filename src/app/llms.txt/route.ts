...
Reservation:
- Direct completion: disabled for launch unless a dedicated AI authentication contract is added.
- Human handoff URL: /booking?mode=agent&date=YYYY-MM-DD&servicePeriod=LUNCH|DINNER&partySize=2&arrivalTime=18:00&course=...
