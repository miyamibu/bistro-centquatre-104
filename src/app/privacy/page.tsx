      ...
      <div className="mx-auto max-w-3xl space-y-8 text-[#2f1b0f]">
        ...
        <div className="card space-y-6 border-[#cfa96d]/35 bg-[#fffdfa] p-6 md:p-8">
          ...
          <section className="space-y-2">
            ...
            <p className="text-sm leading-7 md:text-base">
              ご予約前日のLINEリマインド通知をご希望の場合、LINEアカウントのユーザーIDを予約情報と紐づけて保存します。LINEの友だち追加のみでは予約との自動紐づけは行いません。予約完了画面のリンク、またはLINE公式アカウントの「予約と連携」メニューから設定できます。Webhookの重複防止記録にはLINEユーザーID、返信トークン、メッセージ本文、位置情報を保存せず、イベントID・種別と最小限の非個人メタデータだけを保存します。処理済み記録は30日経過後に順次削除し、未処理・処理中・失敗記録は再処理と障害対応のため保持します。通知の停止をご希望の場合は、店舗までお電話またはお問い合わせフォームよりご連絡ください。トークン・IDトークン・チャンネルシークレットはログに記録しません。
            </p>
          </section>
          <section className="space-y-2">
