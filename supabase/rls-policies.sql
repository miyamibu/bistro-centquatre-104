...
-- Dedicated application roles require explicit RLS policies in addition to
-- their minimum table grants. Keep operational evidence append/update-only.
    ...
    IF EXISTS (SELECT 1 FROM pg_roles WHERE rolname = runtime_role) THEN
      ...
      LOOP
        ...
        EXECUTE format(
          ...
          policy_prefix || '_select', protected_table, runtime_role
        );
        ...
        EXECUTE format(
          ...
          policy_prefix || '_insert', protected_table, runtime_role
        );
        ...
        EXECUTE format(
          ...
          policy_prefix || '_update', protected_table, runtime_role
        );
      END LOOP;
    END IF;
  END LOOP;
